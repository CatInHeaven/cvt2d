public class runme {
  ...
  public static void main(String argv[]) {
    ...
    shapeopJava.shapeop_addPlaneConstraint(s, ids.cast(), 4, weight);
    //add a closeness constraint to the 1st vertex.
    shapeopJava.shapeop_addClosenessConstraint(s, 0, weight);
    //add a closeness constraint to the 4th vertex.
    shapeopJava.shapeop_addClosenessConstraint(s, 3, weight);
