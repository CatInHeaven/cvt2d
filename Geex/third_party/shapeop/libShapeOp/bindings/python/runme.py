...
def main():
  ...
  shapeopPython.shapeop_addPlaneConstraint(s, ids, 4, weight)
  #add a closeness constraint to the 1st vertex.
  shapeopPython.shapeop_addClosenessConstraint(s, 0, weight)
  #add a closeness constraint to the 4th vertex.
  shapeopPython.shapeop_addClosenessConstraint(s, 3, weight)
